...
closedCaptions.init = puppeteer.launch({
        ...
        try {
            await page.goto(`https://8d1ab45384a1.bbbvm.imdt.com.br/demo/demoHTML5.jsp?username=ClosedCaptionsTest&isModerator=true&action=create`, { waitUntil : ['load', 'domcontentloaded']});
